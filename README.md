...
![Лого хакатона](logo.jpg)

## Задачи
- [Геймификация в электронных каналах продаж. (задача от Utair)](https://github.com/lambdamai/aviahackathon/issues/1)
- [Определения безопасного места для посадки безпилотника. (задача от Copter Express)](https://github.com/lambdamai/aviahackathon/issues/2)
